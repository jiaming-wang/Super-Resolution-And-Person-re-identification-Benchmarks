...
|CrossNet: An End-to-end Reference-based Super Resolution Network using Cross-scale Warping (CrossNet)|[ECCV18](http://www.liuyebin.com/CrossNet/CrossNet.pdf)| Cross |
